...
def run_script(split_num, split_pos, config_path, pkl_path, weight_path, label_from, window_size, out_dict_dir, out_dict_name, device_number):
    command = [
        'python3', 'infer_pkl_pyskl.py',
...
if __name__ == '__main__':
    ...
    label_from = "center"
    window_size = 48
    out_dict_dir = "./out_dict/posec3d_non-wheelchair"
    device_number = "0"
    ...
    for i in range(total_splits):
        ...
        # Start the process
        p = run_script(total_splits - 1, i, config_path, pkl_path, weight_path, label_from, window_size, out_dict_dir, out_dict_name, device_number)
        processes.append(p)

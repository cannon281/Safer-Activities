...
# Config
# --------------------------------------------------------------------------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='Infer Wheelchair Action Classification')
parser.add_argument('--config_path', type=str, default="configs/CNN1D_wc_kp.py")
parser.add_argument('--weight_path', type=str, default="weights/CNN1D_wc_kp/CNN1D_wc_kp.pt")
parser.add_argument('--filepath', type=str, default="videos/Wheelchair/wheelchair_demo.mp4")
...
process_one_video(filepath, det_pose_model, model, transforms, device, mode="1080p", show_video=True, save_out_video=True, 
                    out_video_root="./out_video/wheelchair", fall_threshold=0.3, label_from=label_from, viz_kpt=False, label_type="wheelchair")

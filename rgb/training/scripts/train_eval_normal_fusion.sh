#!/bin/bash
# =============================================================================
# Example: Train & evaluate a fusion model on the normal (in-lab) dataset
#
...
#   bash scripts/train_eval_normal_fusion.sh --eval-only
# =============================================================================
...
if [ "$EVAL_ONLY" = false ]; then
    echo "========== Training: VideoMAE + CNN1D Concat Fusion (normal) =========="
    python train.py --config configs/normal/videomae_cnn1d_fusion.py
fi
...
mkdir -p "$EVAL_INLAB"
run_eval "videomae_cnn1d_fusion" \
    "runs/normal_videomae_cnn1d_fusion_seq" \
...
echo ""
echo "Done! Reports in: $EVAL_INLAB/videomae_cnn1d_fusion/report/"
echo "                   $EVAL_NONLAB/videomae_cnn1d_fusion/report/"
